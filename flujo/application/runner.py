...
_signature_cache_id: dict[int, inspect.Signature] = {}
_type_hints_cache_weak: weakref.WeakKeyDictionary[Callable[..., Any], Dict[str, Any]] = (
    weakref.WeakKeyDictionary()
)
_type_hints_cache_id: dict[int, Dict[str, Any]] = {}
...
def _cached_signature(func: Callable[..., Any]) -> inspect.Signature | None:
    try:
        ...
        if id(func) in _signature_cache_id:
            return _signature_cache_id[id(func)]
    try:
    ...
    try:
        ...
        _signature_cache_id[id(func)] = sig
    return sig
...
def _cached_type_hints(func: Callable[..., Any]) -> Dict[str, Any] | None:
    try:
        ...
        if id(func) in _type_hints_cache_id:
            return _type_hints_cache_id[id(func)]
    try:
    ...
    try:
        ...
        _type_hints_cache_id[id(func)] = hints
    return hints
