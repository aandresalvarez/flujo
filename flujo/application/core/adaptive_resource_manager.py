...
class ResourceLimit:
    ...
    def adapt_to_pressure(self, pressure_level: PressureLevel, strategy: AdaptationStrategy) -> float:
...
class AdaptiveResourceManager:
    ...
    def _calculate_overall_pressure(self, metrics: Dict[ResourceType, ResourceMetrics]) -> PressureLevel:
    ...
    def _select_adaptation_strategy(
        ...
        critical_resources = [
            ...
            if m.pressure_level == PressureLevel.CRITICAL
        ]
