...
class PerformanceMonitor:
    ...
    def get_metric_history(self, metric_name: str, window_seconds: Optional[float] = None) -> List[Tuple[float, float]]:
        """Get metric history."""
        with self._lock:
    ...
    def get_system_metrics_history(self, window_seconds: Optional[float] = None) -> List[SystemResourceMetrics]:
            ...
            if self._system_metrics_history:
                ...
                if latest_metrics.disk_io_read_mb_s + latest_metrics.disk_io_write_mb_s > 100:
                    bottlenecks['disk_io'] = {
                        ...
                        'severity': 'medium',
                        'value': latest_metrics.disk_io_read_mb_s + latest_metrics.disk_io_write_mb_s,
