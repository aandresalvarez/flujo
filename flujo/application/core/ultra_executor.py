...
# NonRetryableError is imported from ...exceptions at the top
...
class OptimizationConfig:
    ...
    # Duplicate to_dict method removed - already defined above
...
# Duplicate DefaultProcessorPipeline class removed - already defined above
