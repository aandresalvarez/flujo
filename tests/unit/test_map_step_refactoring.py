...
@pytest.fixture
def map_step(simple_pipeline: Pipeline[str, str]) -> MapStep[TestContext]:
...
class TestMapStepRefactoring:
    ...
    def test_map_step_creation(self, map_step: MapStep[TestContext]) -> None:
    ...
    def test_map_step_properties(self, map_step: MapStep[TestContext]) -> None:
    ...
    def test_map_step_is_complex(self, map_step: MapStep[TestContext]) -> None:
        """Test that MapStep is marked as complex."""
        assert map_step.is_complex is True
        
    def test_map_step_repr(self, map_step: MapStep[TestContext]) -> None:
    ...
    def test_map_step_post_init(self, map_step: MapStep[TestContext]) -> None:
    ...
    def test_map_step_with_empty_iterable(self, simple_pipeline: Pipeline[str, str]) -> None:
        ...
        empty_context = TestContext(initial_prompt="test", items=[])
    ...
    def test_map_step_mapping_functions(self, map_step: MapStep[TestContext]) -> None:
    ...
    def test_map_step_inheritance(self, map_step: MapStep[TestContext]) -> None:
