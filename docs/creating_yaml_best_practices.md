...
- When a child can pause for HITL, set `config.propagate_hitl: true` (default) so the question surfaces to the parent runner and pause/resume works end‑to‑end.
