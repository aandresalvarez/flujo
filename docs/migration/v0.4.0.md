...
from flujo.recipes.factories import make_default_pipeline, make_agentic_loop_pipeline
```
...
|------------|---------|-------------|
| `flujo.recipes` | Pre-built workflow factories | `make_default_pipeline`, `make_agentic_loop_pipeline` |
...
2. Look at the updated [examples](../examples/basic-pipeline.md) for working code
